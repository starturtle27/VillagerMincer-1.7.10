...
public class EntityAIShooting extends EntityAIBase {
   private final EntityLiving entityHost;
   private final IShootingEntity rangedAttackEntityHost;
   ...
   public EntityAIShooting(IShootingEntity par1IRangedAttackMob, double par2, int par4, float par5) {
      this(par1IRangedAttackMob, par2, par4, par4, par5);
   }

   public EntityAIShooting(IShootingEntity par1IRangedAttackMob, double par2, int par4, int par5, float par6) {
   ...
   public boolean shouldExecute() {
      ...
      if (entitylivingbase != null && this.rangedAttackEntityHost.isShootingMode()) {
