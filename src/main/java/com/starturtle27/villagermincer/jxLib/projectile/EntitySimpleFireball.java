...
public abstract class EntitySimpleFireball extends Entity {
   ...
   public EntitySimpleFireball(World par1World) {
      super(par1World);
   ...
   public EntitySimpleFireball(World par1World, double par2, double par4, double par6, double par8, double par10, double par12) {
      super(par1World);
      this.setSize(1.0F, 1.0F);
   ...
   public EntitySimpleFireball(World par1World, EntityLiving par2EntityLiving, double par3, double par5, double par7) {
      super(par1World);
   ...
   public static DamageSource causeSimpleFireBallDamage(EntitySimpleFireball entitySimpleFireball, Entity par1Entity) {
      return (new EntityDamageSourceIndirect("simpleFireball", entitySimpleFireball, par1Entity)).setProjectile();
   }
   ...
   public void vanillaOnUpdate() {
      if (!this.worldObj.isRemote && (this.shootingEntity != null && this.shootingEntity.isDead || !this.worldObj.blockExists((int)this.posX, (int)this.posY, (int)this.posZ))) {
         ...
         for(this.rotationPitch = (float)(Math.atan2((double)f1, this.motionY) * 180.0D / 3.141592653589793D) - 90.0F; this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
         }
