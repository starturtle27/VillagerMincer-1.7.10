...
public class VillagerMincer {
    ...
    public void Init(FMLInitializationEvent event) {
        ...
        strangeMeat = (ItemMeatCan) (new ItemMeatCan(strangeMeatID, 4, 0.1F, true, "meat"))
        ...
        strangeMeat.setAlwaysEdible()
            .setMaxStackSize(64);
        meatCan = (ItemMeatCan) (new ItemMeatCan(meatCanID, 6, 0.1F, true, "meatCan"))
            .setCreativeTab(CreativeTabs.tabFood);
        ...
        emptyCan = (new ItemEmptyCan());
        emeraldCan = (ItemMeatCan) (new ItemMeatCan(emeraldCanID, 6, 0.1F, true, "emeraldCan"))
        ...
        superEmeraldCan = (ItemMeatCan) (new ItemMeatCan(superEmeraldCanID, 120, 0.1F, true, "superEmeraldCan"))
