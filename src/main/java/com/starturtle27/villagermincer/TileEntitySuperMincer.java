...
public class TileEntitySuperMincer extends TileEntity {
   ...
   public void setVilager(EntityVillager entity) {
   ...
   public void updateEntity() {
      super.updateEntity();
      if (this.worldObj.getBlockId(this.xCoord, this.yCoord - 1, this.zCoord) == VillagerMincer.superMincer.blockID) {
   ...
   public EntityVillager getOnVillagerWalking() {
      AxisAlignedBB aa = AxisAlignedBB.getAABBPool().getAABB((double)this.xCoord, (double)this.yCoord, (double)this.zCoord, (double)this.xCoord, (double)(this.yCoord + 1), (double)this.zCoord).expand(1.5D, 1.0D, 1.5D);
   ...
   public void startMince() {
      ...
      if (this.damageCount == 5 && this.villager != null) {
         EntityItem item = new EntityItem(this.worldObj, (double)this.xCoord, (double)this.yCoord - 1.5D, (double)this.zCoord, new ItemStack(VillagerMincer.strangeMeat));
         EntityItem em = new EntityItem(this.worldObj, (double)this.xCoord, (double)this.yCoord - 1.5D, (double)this.zCoord, new ItemStack(Item.emerald));
